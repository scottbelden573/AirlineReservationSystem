// Exercise 7.19 (Airline Reservations System) p315-316
// A small airline has just purchased a computer for its new automated reservations system.
// You've been asked to develop the new system. You're to write an app to assign
...
// should assign a seat in the first class section (seats 1-5).
// If the user types 2, your application should assign a seat in the economy section
// (seats 6-10). Your application should then display a boarding pass indicating the
// person's seat number and whether it's in the first-class or economy section of the plane.
...
public class AirlineReservationSystem {
  ...
  public static void main(String[] args) {
    ...
    int section = 0;
    boolean[] seats = new boolean[10]; // create array seats
    seats[0] = false;                                    // initialize all seats to false
    seats[1] = false;
    seats[2] = false;
    seats[3] = false;
    seats[4] = false;
